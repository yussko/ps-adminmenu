...
RegisterNetEvent("ps-adminmenu:server:givecar", function(data, selectedData)
    ...
    local vehmodel = selectedData['Araç'].value
    ...
    local plate = selectedData['Plaka'] and selectedData['Plaka'].value or vehicleData.plate
    local garage = selectedData['Garaj'] and selectedData['Garaj'].value or Config.DefaultGarage
...
RegisterNetEvent("ps-adminmenu:server:SetVehicleState", function(data, selectedData)
    ...
    local plate = string.upper(selectedData['Plaka'].value)
    local state = tonumber(selectedData['Durum'].value)
...
RegisterNetEvent('ps-adminmenu:server:FixVehFor', function(data, selectedData)
    ...
    local src = source
    local playerId = selectedData['Oyuncu'].value
